 ...
 * <code>CoordinateReferenceSystem</code> objects which can be very expensive to create.
 * <p>
 * During rendering and during data I/O we make use a lof of coordinate transformations, hence
 * caching them might help out a lot.
 * <p>
 * Please note that the deprected method for creaating trasnformation is not implemented.
 * 
 * @author simone
 * @since 2.3
 */
public final class BufferedDefaultCoordinateOperationFactory
        extends
            DefaultCoordinateOperationFactory {

    /** Logger. */
    private final static Logger LOGGER = Logger
            .getLogger(BufferedDefaultCoordinateOperationFactory.class.toString());

    /**
     * This class is an helper class that can be used in order to build an hashing for a pair of
     * source-destination <code>CoordinateReferenceSystem</code> objects.
     * <p>
     * This hash is used to cache the transformations that are pretty time-consuming to build each
     * time.
     * 
    ...
    private final class CRSTransformHashUtil {
        ...
        public CRSTransformHashUtil( final CoordinateReferenceSystem sourceCRS,
            ...
            this.hash = (3 * sourceCRS.hashCode()) + (2 * destinationCRS.hashCode());
        }
        ...
        public boolean equals( Object obj ) {
            ...
            if (obj instanceof CRSTransformHashUtil) {
                ...
                return CRSUtilities.equalsIgnoreMetadata(obj1.getSourceCRS(), sourceCRS)
     ...
     */
    private final static Map pool = Collections.synchronizedMap(new LRULinkedHashMap(50, 0.75f,
            true, 100));
        ...
        synchronized (pool) {
            ...
            if (object == null) {
                ...
                try {
                    ...
                    final CoordinateReferenceSystem destinationCRS = crsHash.getDestinationCRS();
    ...
    public CoordinateOperation createOperation( CoordinateReferenceSystem sourceCRS,
            ...
            FactoryException {
        return (CoordinateOperation) get(new CRSTransformHashUtil(sourceCRS, targetCRS));
    }

 ...
 * @author Touraïvane
 * @deprecated Renamed as {@code UsageImpl} in {@code org.geotools.metadata.iso} subpackage.
 */
public class Usage extends MetadataEntity implements org.opengis.metadata.identification.Usage {
    /**

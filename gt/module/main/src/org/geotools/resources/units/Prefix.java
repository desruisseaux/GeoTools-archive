...
/**
 * Liste de noms de pr�fix qui d�pendront de la langue de l'utilisateur.
 * L'usager ne devrait pas cr�er lui-m�me des instances de cette classe.
 * Une instance statique sera cr��e une fois pour toute lors du chargement
 * de cette classe, et les divers resources seront mises � la disposition
 * du d�veloppeur via les m�thodes statiques.
 *
 * @version 1.0

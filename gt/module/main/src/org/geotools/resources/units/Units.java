...
/**
 * Liste de noms d'unit�s qui d�pendront de la langue de l'utilisateur. L'usager
 * ne devrait pas cr�er lui-m�me des instances de cette classe. Une instance
 * statique sera cr��e une fois pour toute lors du chargement de cette classe,
 * et les divers resources seront mises � la disposition du d�veloppeur

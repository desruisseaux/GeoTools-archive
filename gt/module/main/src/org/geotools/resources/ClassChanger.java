...
public abstract class ClassChanger {
    ...
    /**
     * Liste des classes d'objets pouvant �tre convertis en nombre. Cette liste
     * contiendra par d�faut quelques instances de {@link ClassChanger} pour
     * quelques classes standards du Java, telle que {@link Date}. Toutefois,
     * d'autres objets pourront �tre ajout�s par la suite. Cette liste est
     * <u>ordonn�e</u>. Les classe le plus hautes dans la hierarchie (les
     * classes parentes) doivent appara�tre � la fin.
     */

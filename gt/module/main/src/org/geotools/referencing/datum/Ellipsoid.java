...
public class Ellipsoid extends IdentifiedObject implements org.opengis.referencing.datum.Ellipsoid {
     ...
     */
    protected Ellipsoid(final Map     properties,
     ...
     * @param unit          The units of the semi-major and semi-minor axis values.
     */
    public static Ellipsoid createEllipsoid(final String name,
                                            final double semiMajorAxis,
                                            final double semiMinorAxis,
                                            final Unit   unit)
    {
     ...
     * @param unit          The units of the semi-major and semi-minor axis values.
     */
    public static Ellipsoid createEllipsoid(final Map    properties,
                                            final double semiMajorAxis,
                                            final double semiMinorAxis,
                                            final Unit   unit)
    {
        if (semiMajorAxis == semiMinorAxis) {
            ...
            return new Ellipsoid(properties, semiMajorAxis, semiMinorAxis,
     ...
     *                          values.
     */
    public static Ellipsoid createFlattenedSphere(final String name,
                                                  final double semiMajorAxis,
                                                  final double inverseFlattening,
                                                  final Unit   unit)
    {
     ...
     *                          values.
     */
    public static Ellipsoid createFlattenedSphere(final Map    properties,
                                                  final double semiMajorAxis,
                                                  final double inverseFlattening,
                                                  final Unit   unit)
    {
        if (Double.isInfinite(inverseFlattening)) {
            ...
            return new Ellipsoid(properties, semiMajorAxis,

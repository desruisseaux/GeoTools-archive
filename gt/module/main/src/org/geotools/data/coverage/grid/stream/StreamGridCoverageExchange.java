...
/**
 * A simple stateless GridCoverageExchange that will write/read to/from files
 * and streams
 * 
 * @author jeichar
 * @author <a href="mailto:simboss_ml@tiscali.it">Simone Giannecchini (simboss)</a>
 * @source $URL:
 *         http://svn.geotools.org/geotools/trunk/gt/module/main/src/org/geotools/data/coverage/grid/stream/StreamGridCoverageExchange.java $
 */
public class StreamGridCoverageExchange implements GridCoverageExchange {
	 ...
	 * GridCoverageExchange This method is basic and can easily be fooled at
	 * this point
	 * 
	 * @param source
	 *            the source object to check
	 * 
	 * @return true if source is an object understood by
	 ...
	 *            the source object to check
	 * 
	 * @return true if destination is an object understood by
	 *         StreamGridCoverageExchange
	 * 
	 * @see org.opengis.coverage.grid.GridCoverageExchange#getReader(java.lang.Object,
	 *      org.opengis.coverage.grid.Format)

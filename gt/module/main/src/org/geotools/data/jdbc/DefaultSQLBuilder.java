...
/**
 * Builds a complete SQL query to select the specified attributes for
 * the specified feature type, using a specified filter to generate a
 * WHERE clause.
 * <p>
 ...
 * this is split into a 'preQueryFilter' which can be incorporated into the SQL query
 * itself and a 'postQueryFilter.  The encoder capabilities are used to determine how much
 * of the function can be performed by the database directly and how much has to be
 * performed on the result set.
 *
...
public class DefaultSQLBuilder implements SQLBuilder {
     ...
     * This will typically be from the getSqlBuilder method of a JDBCDataStore subclass
     *
	 ...
	 * @return the filter representing the functionality that must
  ...
  * 
  * @param filter the application filter which must be applied
  * @return the filter representing the functionality that can be performed by the database.
  */
     ...
     *
     * @param sql The StringBuffer that the WHERE clause should be appended to
     * @param preFilter The filter to be used by the encoder class to generate the
     * WHERE clause
     *
     * @throws SQLEncoderException Not thrown here but may be thrown by the encoder
     */
     ...
     * FROM table specification and WHERE clause appropriate to the supplied Filter.
     *
     * @param typeName The name of the table (feature type) to be queried
     ...
     * @param filter The Filter that will be used by the encoder to construct the WHERE clause
     *
     * @return The fully formed SQL SELECT statement
     *
     * @throws SQLEncoderException Not thrown by this method but may be thrown by the encoder
     * class
     */
...
/**
	 ...
	 * <p>
	 * This should typically be overridden in the subclass to return a meaningful
	 * value that the attribute i/o handler can process.
	 * </p>
	 * @param sql A StringBuffer that the column specification can be appended to

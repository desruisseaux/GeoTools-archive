...
METADATA: 
     ...
     *
     * @throws IOException
     * @throws UnsupportedOperationException Creating new schemas is not
     *         supported.
     *
    ...
    //    protected final AttributeReader createAttributeReader(AttributeType[] attrTypes, int fidColumnsCount, ResultSet rs) {
    ...
    //    		
    //    	}
    //    	return new JDBCFeatureReader(attrTypes, attributeIO, fidColumnsCount, rs);    	
    //    }
...
//            }
     ...
     *
     * @param typeName The name of the feature type to get the AttributeTypes
     *        for.
     * @param propertyNames The list of propertyNames to get AttributeTypes
     *        for.
     *

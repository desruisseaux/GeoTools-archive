...
public interface FIDMapper extends Serializable {
     ...
     * <p>This is usually true for mappers that try to generate a FID for
     * tables without primary keys.</p>
     * <p>When this method returns true, it's up to the datastore to decide
     * what to do, but a sane policy may be to prevent Feature writing</p>
     * @return
     */

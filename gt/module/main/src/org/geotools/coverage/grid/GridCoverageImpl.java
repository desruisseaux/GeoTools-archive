...
public class GridCoverageImpl extends org.geotools.coverage.grid.GridCoverage {
     ...
     */
    protected GridCoverageImpl(final GridCoverageImpl coverage) {
        super(coverage);
     ...
     */
    public GridCoverageImpl(final String             name, final ImageFunction    function,
                        final CoordinateReferenceSystem     cs, final GridGeometry gridGeometry,
    ...
    {
        final MathTransform transform = gridGeometry.getGridToCoordinateSystem();
     ...
     */
    public GridCoverageImpl(final String name, final WritableRaster raster, final Envelope envelope)
            throws MismatchedDimensionException
    {
     ...
     */
    public GridCoverageImpl(final String name,         final WritableRaster raster,
                        final CoordinateReferenceSystem cs, final Envelope       envelope,
     ...
     */
    public GridCoverageImpl(final String name,         final WritableRaster raster,
                        final CoordinateReferenceSystem cs, final MathTransform  gridToCS,
                        final double[] minValues,  final double[]       maxValues,
                        final Unit       units,
                        final Color[][]  colors,   final RenderingHints hints)
    {
     ...
     *             ("Relax constraint on placement of this()/super() call in constructors").
     */
    private GridCoverageImpl(final String               name,
     ...
     *         is not the same than the coordinate system's dimension.
     */
    public GridCoverageImpl(final String         name, final RenderedImage  image,
                        final CoordinateReferenceSystem cs, final Envelope    envelope)
        throws MismatchedDimensionException
    {
     ...
     *         failed because the input point has invalid coordinates.
     */
    public double[] evaluate(final GeneralDirectPosition coord, final double[] dest)
        throws CannotEvaluateException
    {
        return evaluate(new Point2D.Double(coord.getOrdinate(0), coord.getOrdinate(2)), dest);
    }
        ...
        throws CannotEvaluateException
    {
        ...
        throw new PointOutsideCoverageException(coord.toString());
    }
     ...
     */
    public synchronized String getDebugString(final GeneralDirectPosition coord) {
        Point2D pixel = new Point2D.Double(coord.getOrdinate(0), coord.getOrdinate(1));
...
testLinear: for (int i=0; i<numBands; i++) {
    ...
    /**
     * Returns a string repr�sentation of this coverage. This string is
	 ...
	 */
	public org.opengis.coverage.grid.GridGeometry getOverviewGridGeometry(int arg0) throws IndexOutOfBoundsException {
		// TODO Auto-generated method stub
		return null;
	}
	 ...
	 */
	public org.opengis.coverage.SampleDimension getSampleDimension(int arg0) throws IndexOutOfBoundsException {
		// TODO Auto-generated method stub
		return null;
	}

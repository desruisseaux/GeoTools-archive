...
public class PropertyException extends IIOException {
    ...
    /**
     * The key for the faulty property, or {@code null} if none.
     */
    private final PropertyParser.Key key;

    /**
     * The alias used for the property, or {@code null} if none.
     */
     ...
     *
     * @return The property key, or {@code null} if none.
     */
     ...
     *
     * <blockquote><pre>
     * org.geotools.coverage.io.MissingPropertyException(key="YMaximum", alias="ULY"):

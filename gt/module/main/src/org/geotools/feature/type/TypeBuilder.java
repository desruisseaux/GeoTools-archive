...
public class TypeBuilder {
	...
	public FeatureType feature() {
		FeatureType type = getTypeFactory().createFeatureType(typeName(),
				properties(), defaultGeometry(), getCRS(), isAbstract(),
	...
	public TypeBuilder attribute(String namespaceURI, String name, Class binding) {
		return attribute(new org.geotools.feature.Name(namespaceURI, name), binding);
	}
	...
	public TypeBuilder attribute(String name, String namespaceURI,
		...
		attribute(new org.geotools.feature.Name(namespaceURI, name), type);
		return this;
	}
	...
	public void addAttribute(String uri, String name, Class binding ){
		addAttribute( new org.geotools.feature.Name( uri, name), binding );
	}
	...
	public void addAttribute(String name, String namespaceURI,
			AttributeType type) {
		addAttribute(new org.geotools.feature.Name(namespaceURI, name), type);
	}
	...
	public TypeBuilder association(String namespaceURI, String name,
		...
		return association(new org.geotools.feature.Name(namespaceURI, name), type);
	}
	...
	public void setDefaultGeometry(String name, String namespaceURI) {
		setDefaultGeometry(new org.geotools.feature.Name(namespaceURI, name));
	}
	...
	public void addMemberType(String namespaceURI, String name,
		...
		addMemberType(new org.geotools.feature.Name(namespaceURI, name), memberType);
	}
	...
	public TypeBuilder member(String name, AssociationType type) {
		return member(new org.geotools.feature.Name(getNamespaceURI(), name), type);
	}

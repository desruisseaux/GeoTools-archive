 ...
 * <p>
 * While we could use a plain AttributeType to capture a Feature instance
 * we would miss out one one important aspect: the schema.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Suggestion: we can look at having this class extend ListFeatureType
 * and exactly specifying how delegation to the getSchema() should occur.
 * (the alternative is to make FeatureType extend ListAttributeType).
 * Something should be done as they have 90% the same API.
 * </p>
 * 
...
public interface FeatureAttributeType extends AttributeType, PrimativeAttributeType {
	 ...
	 * <p>
	 * Exampe implementation:<pre><code>
     ...
     * @deprecated repalce with: <code>type instanceof GeometryAttributeType</code>
	 ...
	 * <p>
	 * TODO: We need a Filter code snipit describing how to enforce

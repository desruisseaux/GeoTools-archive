...
public abstract class SimpleImageReader extends ImageReader {
    ...
    /**
     * V�rifie si l'index de la bande est dans la plage des valeurs
     * autoris�es. L'index maximal autoris� est obtenu en appelant
     * {@link #getNumBands}. L'index de l'image sera aussi v�rifi�.
     *
     * @param  imageIndex Index de l'image dont on veut v�rifier la validit�.
     * @param  bandIndex  Index de la bande dont on veut v�rifier la validit�.
     * @throws IndexOutOfBoundsException si l'index sp�cifi� n'est pas valide.
     * @throws IOException si l'op�ration a �chou�e � cause d'une erreur d'entr�s/sorties.
     */
    ...
    /**
     * Retourne une approximation du nombre d'octets du flot occup�s par les
     * images <code>fromImage</code> inclusivement jusqu'� <code>toImage</code>
     * exclusivement. L'impl�mentation par d�faut calcule cette longueur en
     ...
     * @param   toImage Index suivant celui de la derni�re image � prendre en
     *                  compte, ou -1 pour prendre en compte toutes les images
     *                  restantes jusqu'� la fin du flot.
     * @return Le nombre d'octets occup�s par les images sp�cifi�s, ou -1 si
     *         cette longueur n'a pas pu �tre calcul�e. Si le calcul pr�cis de
     *         cette longueur serait prohibitif, cette m�thode est autoris�e �
     *         retourner une simple approximation ou m�me � retourner la longueur
     *         totale du flot.

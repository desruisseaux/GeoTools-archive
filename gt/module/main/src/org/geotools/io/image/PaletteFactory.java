...
public class PaletteFactory {
    ...
    /**
     * Proc�de au chargement d'un ensemble de couleurs. Les couleurs doivent
     * �tre cod�es sur trois colonnes dans un fichier texte. Les colonnes
     * doivent �tre des entiers de 0 � 255 correspondant (dans l'ordre) aux
     * couleurs rouge (R), verte (G) et bleue (B). Les lignes vierges ainsi
     * que les lignes dont le premier caract�re non-blanc est # seront ignor�es.
     *
     * @param  input Flot contenant les codes de couleurs de la palette.
     * @return Couleurs obtenues � partir des codes lues.
     * @throws IOException si une erreur est survenue lors de la lecture.
     * @throws IIOException si une erreur est survenue lors de l'interpr�tation des codes de couleurs.
     */
    ...
    /**
     * V�rifie que la valeur <code>value</code> sp�cifi�e

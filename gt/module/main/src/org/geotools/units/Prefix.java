 ...
 * peut par exemple repr�senter des "centi" (symbole "c") comme dans "centim�tres"
 * (symbole "cm"). La description du paquet <code>org.geotools.units</code> donne
 * une liste des pr�fix standards du syst�me SI.
 *
 * <p><em>Note: this class has a natural ordering that is inconsistent with equals.</em>
 * La m�thode {@link #compareTo} ne compare que le champ {@link #amount}, tandis
 * que la m�thode {@link #equals} compare tous les champs ({@link #name},
...
final class Prefix implements Comparable, Serializable {
     ...
     * "milli", "centi" et "kilo". Certaines unit�s (notamment des unit�s du type {@link ScaledUnit})

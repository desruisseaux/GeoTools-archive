...
public class ColorBar extends JComponent {
    ...
    private Rectangle2D paint(final Graphics2D graphics, final Rectangle bounds) {
        ...
        if (labelVisibles && graduation!=null) {
            /*
             * Pr�pare l'�criture de la graduation. On v�rifie quelle longueur
             * (en pixels) a la rampe de couleurs et on calcule les co�fficients
             * qui permettront de convertir les valeurs logiques en coordonn�es
             * pixels.
             */
            ...
            /*
             * Proc�de � l'�criture de la graduation.
             */
     ...
     * de calculer l'espace qu'elle occupe. Cette classe peut aussi r�agir
     * � certains �v�nements.
     *
     * @version $Id: ColorBar.java,v 1.9 2004/02/13 14:29:37 desruisseaux Exp $
     * @author Martin Desruisseaux
    ...
    private final class UI extends ComponentUI implements PropertyChangeListener {
        ...
        /**
         * Retourne la dimension pr�f�r�e de cette rampe de couleurs.
         */
        ...
        /**
         * Dessine la rampe de couleurs vers le graphique sp�cifi�.  Cette m�thode a
         * l'avantage d'�tre appel�e automatiquement par <i>Swing</i> avec une copie
         * d'un objet {@link Graphics}, ce qui nous �vite d'avoir � le remettre dans
         * son �tat initial lorsqu'on a termin� le tra�age de la rampe de couleurs.
         * On n'a pas cet avantage lorsque l'on ne fait que red�finir
         ...
         * fois qu'une propri�t� de l'axe a chang�e.
         */

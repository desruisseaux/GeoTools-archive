...
//                throw new IOException("Schema Cannot be written to "+f2);
    ...
    public static void writeSchema(Schema schema, File f, Map hints) throws IOException{
    ...
    private static void writeSchema(Schema schema,PrintHandler ph, Map hints) throws IOException{
        ...
        ai.addAttribute("","targetNamespace","","anyUri",schema.getTargetNamespace());
        ai.addAttribute("","xmlns","","anyUri",XSISimpleTypes.NAMESPACE);
        ai.addAttribute("","xmlns:"+schema.getPrefix(),"","anyUri",schema.getTargetNamespace());
        
        Schema[] imports = schema.getImports();
        for(int i=0;i<imports.length;i++){
            ai.addAttribute("","xmlns:"+imports[i].getPrefix(),"","anyUri",imports[i].getTargetNamespace());
        }
    ...
    private static void writeImport(Schema schema, PrintHandler ph, Map hints) throws IOException{
        AttributesImpl ai = new AttributesImpl();
        ...
        ai.addAttribute("","namespace","","anyUri",schema.getTargetNamespace());
    ...
    private static void writeAny(Any any, Schema schema, PrintHandler ph, Map hints) throws IOException{
        AttributesImpl ai = new AttributesImpl();
...
//                    	    break;
    ...
    private static void writeFacet(Facet facet, Schema schema, PrintHandler ph, Map hints) throws IOException{
        if(facet == null)
            return;
        AttributesImpl ai = new AttributesImpl();

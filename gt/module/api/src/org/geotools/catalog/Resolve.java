 ...
 * objects implementing the IAdaptable interface morph or adapt themselves into
 * objects implementing a different interface.
 * </p>
 * 
 * <p>
 * The resolve pattern is slightly different in that morphing or adapting 
 * (ie. resolving) into a different object involves a blocking call in which I/O 
 ...
 * or into a list of children, called members. Like any other resolve, these are 
 * blocking operations. Parents and members must also implement the Resolve 
 * interface. 
 * </p>
 * 
...
public interface Resolve {
	...
	/**
     * Blocking method which is used to resolve into an instance of a particular
     * class.
     * <p>
     * Required adaptions will be listed in Abstract Classes that implement this
     * interface.
     * </p>
     * 
     * @param adaptee Class of object to resolve into.
     * @param monitor Progress monitor used to report status while blocking. May 
     * be null.
     * 
    ...
    /**
     * Blocking method which resolves this instance into its parent. This method
     * may return null if the parent can not be determined.
     * 
     * @param monitor Progress monitor used to report status while blocking. May 
     * be null.
     * 
     ...
     * This method returns null if the instance does not have any children, or 
     * the children could be determined.
     * 
     * @param monitor Progress monitor used to report status while blocking. May 
     * be null.
     * 
     * @return A list (possibly empty) of members, null if the members could
     * not be obtained or the instance has not members. Objects in the returned
     * list implement the Resolve interface.
     * 
     * @throws IOException in the result of an I/O error.
     */
    ...
    /**
     * Removes a listener from the Resolve. Support for event notification is up 

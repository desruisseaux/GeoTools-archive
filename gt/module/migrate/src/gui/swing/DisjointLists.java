...
public class DisjointLists extends JPanel {
    ...
    public DisjointLists() {
        ...
        final JButton add        = getButton(loader, "StepBack",    "<",  "Ajouter les �l�ments s�lectionn�s");
        final JButton remove     = getButton(loader, "StepForward", ">",  "Retirer les �l�ments s�lectionn�s");

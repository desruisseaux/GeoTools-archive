...
final class GradualColormapOperation extends IndexColorOperation {
    /**
     * Constante indiquant qu'il faut garder la premi�re couleur
     * lorsqu'une plage de couleurs constantes est rencontr�e.
     */
    private static final int KEEP_LOWER_COLOR = +1;

    /**
     * Constante indiquant qu'il faut garder la derni�re couleur
     * lorsqu'une plage de couleurs constantes est rencontr�e.
     */
     ...
     * lorsque l'op�rateur trouve une plage de couleurs
     * identiques.
     *
    ...
    /**
     * Construit une op�ration qui interpolera les couleurs.
     *
     * @param mode Indique quelle couleur il faut garder lorsque l'op�rateur trouve une plage de
     *             couleurs identiques. La valeur {@link #KEEP_LOWER_COLOR} indique qu'il faut
     *             laisser inchang�e la premi�re couleur de la plage et interpoler les autres
     *             (la derni�re couleur de la plage sera donc la plus affect�e). La valeur
     *             {@link #KEEP_UPPER_COLOR} indique au contraire qu'il faut laisser inchang�e
     *             la derni�re couleur de la plage et interpoler les autres (la premi�re couleur
     *             sera donc la plus affect�e).
     */

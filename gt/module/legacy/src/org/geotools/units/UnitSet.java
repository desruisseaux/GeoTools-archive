...
/**
 * Banque d'unit�s standards ou courantes. La m�thode {@link #main}
 * de cette classe construit un tableau de type <code>Unit[]</code> et l'enregistre
 * en binaire dans le fichier {@link #PATHNAME}. Cette banque d'unit�s pourra �tre
 * relue par {@link Unit} lorsque des unit�s sont demand�es.
 *
 * @version 1.0
...
final class UnitSet implements Serializable {
     ...
     * enregistrer les unit�s sous une forme
     * binaire.
     */
    public static final String PATHNAME = "org/geotools/units/database.serialized";

    /**
     * Liste des pr�fix standards du syst�me SI.
     */
    private final PrefixSet prefix;

    /**
     * Liste de plusieurs unit�s du syst�me SI
     * ainsi que quelques autres unit�s.
     */
    private final Unit[] units;

    /**
     * Cr�e une liste d'unit�s par d�faut. Cette liste contiendra
     * la plupart des unit�s d�finies dans la brochure SI.
     */
    private UnitSet() {
        ...
        final BaseUnit METRE     = BaseUnit.getInstance("length",                    "m",      ALL); // m�tre
        ...
        final BaseUnit AMPERE    = BaseUnit.getInstance("electric current",          "A",      ALL); // amp�re
        ...
        final BaseUnit STERADIAN = BaseUnit.getInstance("solid angle",               "sr",    NONE); // st�radian
        final BaseUnit PSS78     = BaseUnit.getInstance("salinity",                  "PSS78", NONE); // salinit�
        ...
        units = new Unit[] {
            ...
            ScaledUnit.getInstance(Math.PI/180,         RADIAN,                 "�",      NONE), // degr� d'angle
            ...
            ScaledUnit.getInstance(1000,                KILOGRAM,               "t",      NONE), // tonne m�trique
            ScaledUnit.getInstance(1.6021773349E-19,    JOULE,                  "eV",      ALL), // �lectronvolt
            ScaledUnit.getInstance(1.660540210E-27,     KILOGRAM,               "u",      NONE), // unit� de masse atomique unifi�e
            ScaledUnit.getInstance(1.4959787069130E+11, METRE,                  "ua",     NONE), // unit� astronomique
            ...
            ScaledUnit.getInstance(1.624,               METRE,                  "brasse", NONE), // brasse fran�aise
            ...
            ScaledUnit.getInstance(1E-10,               METRE,                  "�",      NONE), // �ngstr�m
            ...
            ScaledUnit.getInstance(2.58E-4,             COULOMB_PER_KILOGRAM,   "R",      NONE), // r�ntgen
            ...
            ScaledUnit.getInstance(101325.0,            PASCAL,                 "atm",    NONE), // atmosph�re normale
            ScaledUnit.getInstance(0.4535,              KILOGRAM,               "pound",  NONE), // livre
            ScaledUnit.getInstance(0.4535/16,           KILOGRAM,               "onze",   NONE), // onze
            OffsetUnit.getInstance(273.15,              KELVIN,                 "�C",     NONE), // degr� celcius
            ...
            //
            //       Mais on r�alise que ce code entra�ne des erreurs d'arrondissements. Par exemple 0�C
            //       est convertie en 31.999999999999943�F au lieu de 32�F. Avec les constantes utilis�es,
            //       ces erreurs d'arrondissements semblent s'annuler. Ces constantes ont �t� obtenues par
            //       le code ci-dessous, qui suit le m�me chemin que les m�thodes "Unit.convert".
            //
    ...
    /**
     * Envoie les nombres sp�cifi� vers le p�riph�rique de sortie standard.
     * Au passage, v�rifie si ces nombres correspondent � ceux qui �taient
     * attendues.
     */
    ...
    /**
     * Envoie les unit�s sp�cifi� vers le p�riph�rique de sortie standard.
     * Au passage, v�rifie si ces unit�s correspondent � celles qui �taient
     * attendues.
     */
    ...
    /**
     * Proc�de � la cr�ation de la banque des unit�s. La banque sera enregistr�e en binaire dans le fichier
     * {@link #PATHNAME}. Avant d'effectuer l'enregistrement, cette m�thode effectue quelques tests pour
     * v�rifier que les unit�s fonctionnent correctement.
     *
     * @throws UnitException Si une erreur est survenue lors des test.
     * @throws IOException Si une erreur est survenue lors de l'�criture de fichier.
     */
    public static void main(final String[] args) throws UnitException, IOException {
        ...
        if (args.length==0 || !args[0].equals("silent")) {
            ...
            print("[m].scale(1E-6)"         , METRE.scale   (1.0E-6),                "�m" );
        ...
        /*
         * Enregistre les unit�s en binaire.
         */
        if (true) {

 ...
 * </ul>
 *
 * @version $Id: RenderedGridMarks.java 10796 2005-01-28 19:09:18Z dzwiers $
...
public class RenderedGridMarks extends RenderedMarks {
    ...
    /**
     * Nombre de points � d�cimer selon l'axe des <var>x</var> et des <var>y</var>.
    ...
    /**
     * Espace minimal (en points) � laisser entre les points de la grille selon les axes
     * <var>x</var> et <var>y</var>. La valeur 0 d�sactive la d�cimation selon cet axe.
     */
    private int spaceX=0, spaceY=0;

    /**
     * Indique si la d�cimation est active. Ce champ prend la valeur <code>true</code>
     * si <code>decimateX</code> ou <code>decimateY</code> sont sup�rieurs � 1.
     */
    ...
    /**
     * Buffer temporaire pour l'�criture des "tooltip".
     */
    private transient StringBuffer buffer;

    /**
     * Objet � utiliser pour l'�criture des angles.
     */
     ...
     *
     * @param spaceX Espace minimal (en points) selon <var>x</var> � laisser entre les
     *        points de la grille. La valeur 0 d�sactive la d�cimation selon cet axe.
     * @param spaceY Espace minimal (en points) selon <var>y</var> � laisser entre les
     *        points de la grille. La valeur 0 d�sactive la d�cimation selon cet axe.
     */
    ...
    protected class Iterator extends MarkIterator {
        ...
        /**
         * Indique si la marque � l'index sp�cifi� est visible dans le clip sp�cifi�.
         * Le rectangle <code>clip</code> doit avoir �t� obtenu par {@link #getGridClip}.
         */
        ...
        /**
         * Calcule les composantes <var>x</var> et <var>y</var> du vecteur � l'index sp�cifi�.
         */
         ...
         * de coordonn�es du {@linkplain #getGridCoverage grid coverage}.
         *
        ...
        /**
         * Retourne l'amplitude � la position d'une marque. Si une d�cimation a �t� sp�cifi�e avec
         * la m�thode {@link #setDecimation}, alors cette m�thode calcule la moyenne vectorielle
         * (la moyenne des composantes <var>x</var> et <var>y</var>) aux positions des marques �
        ...
        /**
         * Retourne la direction de la valeur d'une marque. Si une d�cimation a �t� sp�cifi�e avec
         * la m�thode {@link #setDecimation}, alors cette m�thode calcule la moyenne vectorielle
         * (la moyenne des composantes <var>x</var> et <var>y</var>) aux positions des marques �
         ...
         * Lorsque deux bandes sont utilis�es, la forme par d�faut sera une fl�che
         * dont l'origine est � (0,0) et qui pointe dans la direction des <var>x</var>
         * positifs (soit � un angle de 0 radians arithm�tiques).
         *

 ...
 *
 * NOTE: Do not delete this, it will be used for the new feature model.
 */
...
//					gtType, Types.attributeName(uri,name),1,1,false
//				);
//				properties.add(ad);
//			}
//		}
...
//	 */
//	private TypeName name(XSDTypeDefinition type) {
//		return Types.typeName(type.getTargetNamespace(),type.getName());
//	}
}

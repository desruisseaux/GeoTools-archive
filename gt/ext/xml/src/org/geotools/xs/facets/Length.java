...
public abstract class Length {
	...
	public static final Length LIST = new Length(){
		public int length( XSDTypeDefinition definition ){
			try {
				...
				if( facet == null ) return Integer.MAX_VALUE;
		...
		public void validate( XSDTypeDefinition definition, Object value ) throws ValidationException {
			...
			if( value instanceof Collection ) length = ((Collection)value).size();
			if( value.getClass().isArray() ) length = Array.getLength( value );
			if( value instanceof Integer ) length = ((Integer)value).intValue();
	...
	public abstract void validate( XSDTypeDefinition definition, Object value ) throws ValidationException;

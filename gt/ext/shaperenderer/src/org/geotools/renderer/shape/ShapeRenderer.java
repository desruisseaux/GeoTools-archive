...
public class ShapeRenderer {
	...
	private void processStylersNoCaching(Graphics2D graphics,
        ...
        for( int i = 0; i < featureStylers.length; i++ ) {
            ...
            DbaseFileReader dbfreader = ShapefileRendererUtil.getDBFReader(datastore);
                ...
                try {
                    while( true ) {
                        try {
                            ...
                            Feature feature = createFeature(type, record, dbfreader, typeName
                                    + index);
                            index++;
                            ...
                            for( Iterator it = ruleList.iterator(); it.hasNext(); ) {
                                ...
                                if ((filter == null) || filter.contains(feature)) {
                                    ...
                                    processSymbolizers(graphics, feature, geom, symbolizers,
                                            scaleRange);
    ...
    private void processStylersCaching( Graphics2D graphics, ShapefileDataStore datastore,
...
//                try {
//                    style = styleFactory.createStyle(feature, getTestStyle(), scaleRange);
//                    painter.paint(graphics, getLiteShape2(geom), style, scaleDenominator);
//                } catch (Exception e) {
//                    fireErrorEvent(e);
//                }
            }
    ...
    private double[] getPointSample( SimpleGeometry geom, boolean isPolygon ) {
        ...
        int step = geom.coords[largestPart].length < NUM_SAMPLES
                ? 2
    ...
    private class NonValidatingFeature extends DefaultFeature {
         ...
         */
        protected NonValidatingFeature( DefaultFeatureType schema, Object[] attributes )
                throws IllegalAttributeException {

...
public class PolygonShapeTest extends TestCase {
	...
	public static void testPolygonWithHoles() throws Exception {
		double[] coord1 = new double[] { 0.0, 0.0, 0.0, 200.0, 200, 200.0,
				200.0, 0.0, 0.0, 0.0 };
		double[] coord2 = new double[] { 50.0, 50.0, 50.0, 150.0, 150.0, 150.0,
				150.0, 50.0 };
	...
	public static void testMultiPolygonNoOverlap() throws Exception {
		double[] coord1 = new double[] { 0.0, 0.0, 0.0, 100.0, 100, 100.0,
				100.0, 0.0, 0.0, 0.0 };
		double[] coord2 = new double[] { 150.0, 150.0, 150.0, 250.0, 250.0,
				250.0, 250.0, 150.0 };
		double[][] coords = new double[][] { coord1, coord2 };
	...
	public static void testMultiPolygonOverlap() throws Exception {
		double[] coord1 = new double[] { 0.0, 0.0, 0.0, 100.0, 100, 100.0,
				100.0, 0.0, 0.0, 0.0 };
		double[] coord2 = new double[] { 50.0, 50.0, 50.0, 250.0, 250.0, 250.0,
				250.0, 50.0 };
		double[][] coords = new double[][] { coord1, coord2 };

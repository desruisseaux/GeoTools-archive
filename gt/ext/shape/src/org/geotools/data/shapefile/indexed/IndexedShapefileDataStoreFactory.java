...
public class IndexedShapefileDataStoreFactory
    ...
    public static final Param CREATE_SPATIAL_INDEX =
        new Param("create spatial index", Boolean.class,
                  ...
                  false);
    public static final Param SPATIAL_INDEX_TYPE =
        new Param("index type", Byte.class,
    ...
    public boolean canProcess(Map params) {
        ...
        if( params.containsKey(SPATIAL_INDEX_TYPE.key)){
			...
			try {
	            ...
	            accept=accept&& (type.equals(TREE_GRX) ||type.equals(TREE_QIX)||type.equals(TREE_NONE) );
			} catch (Exception e) {
				accept=false;
			}
        }

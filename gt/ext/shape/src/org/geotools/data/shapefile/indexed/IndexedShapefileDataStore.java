...
public class IndexedShapefileDataStore extends ShapefileDataStore {
	...
	protected FeatureReader createFeatureReader(String typeName, Reader r,
		...
		return new org.geotools.data.FIDFeatureReader(r, new ShapeFIDReader(
				typeName, r), readerSchema);
	}
			...
			try {
				...
				if (parent != null) {
					schema = FeatureTypeFactory.newFeatureType(
							readAttributes(), createFeatureTypeName(),

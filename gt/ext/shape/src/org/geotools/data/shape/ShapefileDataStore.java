...
import org.geotools.data.shape.shp.ShapeType;
import org.geotools.data.shape.shp.ShapefileException;
import org.geotools.data.shape.shp.ShapefileHeader;
import org.geotools.data.shape.shp.ShapefileReader;
import org.geotools.data.shape.shp.ShapefileWriter;
...
public class ShapefileDataStore extends AbstractFileDataStore {
    ...
    private static final byte TREE_NONE = 0;
    private static final byte TREE_GRX = 1;
    private static final byte TREE_QIX = 2;
    ...
    throws java.net.MalformedURLException
    {
        this(url, useMemoryMappedBuffer, false, true);
    }
    ...
    protected ShapefileReader openShapeReader() throws IOException {
        ...
        try {
            return new ShapefileReader(rbc, useMemoryMappedBuffer, true);
    ...
    protected static class Reader extends AbstractAttributeIO
        ...
        public Reader(AttributeType[] atts, ShapefileReader shp,
                      DbaseFileReader dbf, List goodRecs) 
        {
            super(atts);
            this.shp = shp;
            this.dbf = dbf;

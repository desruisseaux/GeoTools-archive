...
public class ShapefileDataStoreTest extends TestCaseSupport {
    ...
    protected FeatureCollection loadFeatures(IndexedShapefileDataStore s) throws Exception {
	...
	private void testEnvelope(FeatureCollection features, byte treeType) throws MalformedURLException, IOException {
		IndexedShapefileDataStore s = new IndexedShapefileDataStore(getTestResource(STATE_POP),null, true, true,treeType);
    ...
    public void testCreateAndReadQIX() throws Exception {
		...
		IndexedShapefileDataStore ds=new IndexedShapefileDataStore(url, null, true, true, IndexedShapefileDataStore.TREE_QIX);
    ...
    public void testCreateAndReadGRX() throws Exception {
		...
		IndexedShapefileDataStore ds=new IndexedShapefileDataStore(url, null, true, true, IndexedShapefileDataStore.TREE_GRX);
		FeatureCollection features = ds.getFeatureSource().getFeatures();
		Iterator iter=features.iterator();
		while( iter.hasNext()){
			iter.next();
    ...
    private void writeFeatures(IndexedShapefileDataStore s,FeatureCollection fc) throws Exception {

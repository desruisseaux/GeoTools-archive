...
public class GMLMultiPolygonPropertyTypeBindingTest
    ...
    protected void setUp() throws Exception {
        ...
        geometry = createElement(GML.NAMESPACE, "myMultiPolygon",
                GML.MULTIPOINTTYPE, null);
    ...
    public void testWithGeometry() throws Exception {
        Polygon p1 = new GeometryFactory().createPolygon(new GeometryFactory()
                .createLinearRing(new Coordinate[] {
                        new Coordinate(0, 0), new Coordinate(1, 1),
                        new Coordinate(2, 2), new Coordinate(0, 0)
                    }), null);
        Polygon p2 = new GeometryFactory().createPolygon(new GeometryFactory()
                .createLinearRing(new Coordinate[] {
        ...
        MultiPolygon p = (MultiPolygon) s1.parse(association, node,

...
public class GMLLinearRingTypeBindingTest extends AbstractGMLBindingTest {
	...
	ElementInstance ring,coord1,coord2,coord3,coord4,coord5,coords;
	...
	public void testCoordFour() throws Exception {
		Node node = createNode(
			ring, new ElementInstance[]{coord1,coord2,coord3,coord4}, 
			new Object[]{
		...
		GMLLinearRingTypeBinding s = (GMLLinearRingTypeBinding)
	...
	public void testCoordLessThanFour() throws Exception {
		Node node = createNode(
			ring, new ElementInstance[]{coord1,coord2,coord3}, 
			new Object[]{
				createCoordinateSequence(new Coordinate(1,2)),
				createCoordinateSequence(new Coordinate(3,4)),
				createCoordinateSequence(new Coordinate(1,2))
	...
	public void testCoordMoreThanFour() throws Exception {
		Node node = createNode(
			ring, new ElementInstance[]{coord1,coord2,coord3,coord4,coord5}, 
			new Object[]{
				createCoordinateSequence(new Coordinate(1,2)),
				createCoordinateSequence(new Coordinate(3,4)),
				createCoordinateSequence(new Coordinate(5,6)),
	...
	public void testCoordinatesFour() throws Exception {
		Node node = createNode(
			ring, new ElementInstance[]{coords}, 
			new Object[]{
		...
		Node node = createNode(
			...
			new Object[]{
				createCoordinateSequence(
					new Coordinate[]{
						new Coordinate(1,2), new Coordinate(3,4),
						new Coordinate(5,6),new Coordinate(7,8),
						new Coordinate(1,2)
					}
				),
			}, null, null

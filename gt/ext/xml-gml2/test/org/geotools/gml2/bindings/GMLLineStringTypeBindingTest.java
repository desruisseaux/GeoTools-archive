...
public class GMLLineStringTypeBindingTest extends AbstractGMLBindingTest {
	...
	ElementInstance line,coord1,coord2,coord3,coords;
	...
	public void testCoordTwo() throws Exception {
		Node node = createNode(
			line, new ElementInstance[]{coord1,coord2}, 
			new Object[]{
		...
		GMLLineStringTypeBinding s = (GMLLineStringTypeBinding)
	...
	public void testCoordSingle() throws Exception {
		Node node = createNode(
			line, new ElementInstance[]{coord1}, 
			new Object[]{
				createCoordinateSequence(new Coordinate(1,2)),
			}, null, null
		);
	...
	public void testCoordMulti() throws Exception {
		Node node = createNode(
			line, new ElementInstance[]{coord1,coord2,coord3}, 
			new Object[]{
				createCoordinateSequence(new Coordinate(1,2)),
				createCoordinateSequence(new Coordinate(3,4)),
	...
	public void testCoordinatesTwo() throws Exception {
		Node node = createNode(
			line, new ElementInstance[]{coords}, 
			new Object[]{
	...
	public void testCoordinatesMulti() throws Exception {
		Node node = createNode(
			line, new ElementInstance[]{coords}, 
			new Object[]{
				createCoordinateSequence(new Coordinate[]{new Coordinate(1,2), new Coordinate(3,4), new Coordinate(5,6)}),
			}, null, null
		);

...
public abstract class BaseCoverageProcessingNode implements
	...
	private final static class CoverageProcessingCycleDetector {
		...
		private boolean check(CoverageProcessingNode baseNode,
			...
			if (currentNode.getNumberOfSinks() == 0)
				return false;
			final List sinks = currentNode.getSinks();
			final Iterator it = sinks.iterator();
			while (it.hasNext()) {
				// get this node
				final CoverageProcessingNode nextNode = (CoverageProcessingNode) it
						.next();

				// check the start point
				if (baseNode.equals(nextNode))
					return true;

				// no cyle here, let's dig
				if (check(baseNode, nextNode))
					return true;
	 ...
	 */
	private final List sources = new ArrayList(10);

	/**
	 * {@link List}  of sinks for this  {@link CoverageProcessingNode} .
	 * @uml.property  name="sinks"
	 */
	private final List sinks = new ArrayList(10);
	 ...
	 * 
	 * <p>
	 * Note that this method is invoked through this framework hence it is run
	 * within a critical section.
	 * 
	 * @return a {@link GridCoverage2D} which is the result of the processing.
	 */
	protected abstract GridCoverage2D execute();
	...
	public synchronized void dispose(boolean force) {
		...
		while (it.hasNext()) {
			final CoverageProcessingNode source = (CoverageProcessingNode) it
					.next();
	 ...
	 * {@link CoverageProcessingNode} and also of all its sources.
	 * <p>
	 * In case something bad happens a {@link CoverageProcessingException} is
	 * thrown.
	 * 
	 * @uml.property name="output"
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#addSink(org.geotools.renderer.gridcoverage.CoverageProcessingNode)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#addSource(org.geotools.renderer.gridcoverage.CoverageProcessingNode)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#getSink(int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#getSinks()
	 */
	/**
	 * @return
	 * @uml.property  name="sinks"
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#getSource(int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#getSources()
	 */
	/**
	 * @return
	 * @uml.property  name="sources"
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#removeSink(org.geotools.renderer.gridcoverage.CoverageProcessingNode)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#removeSink(int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#removeSource(org.geotools.renderer.gridcoverage.CoverageProcessingNode)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#getNumberOfSinks()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#getNumberOfSources()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#getDescription()
	 */
	/**
	 * @return
	 * @uml.property  name="description"
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#getName()
	 */
	/**
	 * @return
	 * @uml.property  name="name"
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.geotools.renderer.gridcoverage.CoverageProcessingNode#removeSource(int)
	 */

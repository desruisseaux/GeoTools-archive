...
class BandMergeNode extends BaseCoverageProcessingNode implements
	 ...
	 * 
	 * @param hints
	 *            {@link Hints} to control this node behaviour.
	 */
	...
	protected GridCoverage2D execute() {
		...
		if (sources != null || sources.isEmpty()) {
			...
			do {
				...
				//
				// //
				final CoverageProcessingNode currentSourceNode = (CoverageProcessingNode) it
						.next();
				final GridCoverage2D currentSourceCoverage = currentSourceNode
						.getOutput();
				final GridGeometry2D gg = (GridGeometry2D) currentSourceCoverage
						.getGridGeometry();

 ...
 */
public class LinearColorMap extends AbstractList
		implements ColorMapTransform {
...
//	}
	...
	public boolean isHasDefault() {
		initColorModel();
		return this.piecewise.isHasDefault();
	}
	...
	public DomainElement1D getDomainElement(double sample) {
		initColorModel();
		...
		if(prefiltering&&this.preFilteringPiecewise.contains(new Double(sample)))
			return preFilteringPiecewise.getDomainElement(sample);
		return piecewise.getDomainElement(sample);
	}

	public DomainElement1D[] getDomainElements() {
//		initColorModel();
//		final boolean prefiltering=this.preFilteringElements != null;
//		final DomainElement1D[] de = new DomainElement1D[this.standardElements.length
//				+ (prefiltering ? this.preFilteringElements.length
//						: 0)];
//		for(int i=0;i<de.length;i++){
//			if(i<this.standardElements.length)
//				de[i]=standardElements[i];
//			else
//				de[i]=preFilteringElements[i-standardElements.length];
//			
//		}
//		return de;
		return (DomainElement1D[]) this.standardElements.clone();
	}

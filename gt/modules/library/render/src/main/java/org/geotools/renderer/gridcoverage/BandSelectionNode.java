...
/**
 * This {@link CoverageProcessingNode} has been built for taking care of the
 * band select operation within the context of applying SLD 1.0.
 * 
...
class BandSelectionNode extends StyleVisitorCoverageProcessingNodeAdapter
	...
	protected GridCoverage2D execute() {
		...
		//
		// /////////////////////////////////////////////////////////////////////
		final List sources = this.getSources();
	 ...
	 * 
	 * <p>
	 * <code>-1</code> warns about a possible error.

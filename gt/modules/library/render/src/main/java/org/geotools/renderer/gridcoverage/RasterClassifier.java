...
public class RasterClassifier extends PointOpImage {
	 ...
	 */
	private final ColorMapTransform pieces;
	...
	private RasterClassifier(final RenderedImage image,
			final ColorMapTransform lic, int bandIndex,
	...
	private static ImageLayout prepareLayout(RenderedImage image,
			ImageLayout layout, ColorMapTransform lic) {
		// //
		//
							...
							do {
								...
								if (useLast) {
									if (last != null && last.contains(value))
										...
										last = transform = (PiecewiseTransform1DElement) pieces
												.getDomainElement(value);
									}
								} else
									transform = (PiecewiseTransform1DElement) pieces
											.getDomainElement(value);
	...
	private static final class CRIF extends CRIFImpl {
		...
		public RenderedImage create(final ParameterBlock param,
			...
			final LinearColorMap lic = (LinearColorMap) param

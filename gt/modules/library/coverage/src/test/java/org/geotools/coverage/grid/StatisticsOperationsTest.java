...
public class StatisticsOperationsTest extends TestCase {
	...
	public void testExtrema() {
		...
		assertEquals(((double[]) coverage.getProperty("minimum"))[0], 250.0);
		assertEquals(((double[]) coverage.getProperty("maximum"))[0], 748.0);
		...
		assertEquals(((double[]) coverage.getProperty("minimum"))[0], 250.0);
		assertEquals(((double[]) coverage.getProperty("maximum"))[0], 746.0);

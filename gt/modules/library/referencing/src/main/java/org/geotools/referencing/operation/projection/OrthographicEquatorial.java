 ...
 *
 * @deprecated Renamed as {@link EquatorialOrthographic} for consistency with OGC and EPSG naming.
 */
public class OrthographicEquatorial extends EquatorialOrthographic {
    /**

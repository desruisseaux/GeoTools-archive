...
public class H2Utils {
    ...
    static final List typeNames(H2Content content) throws Exception {
        ...
        try {
            ...
            ResultSet tables = metaData.getTables(null, content.getDatabaseSchema(), "%", null);
     ...
     */
    static final String[] sqlTypeNames(H2ContentState state)
        throws Exception {
     ...
     * @throws Exception Any I/O errors that occur.
     */
    static final FeatureType buildFeatureType(H2ContentState state, H2TypeBuilder builder)
        throws Exception {
        H2DataStore dataStore = state.getDataStore();
        ContentEntry entry = state.getEntry();
     ...
     * @throws Exception Any I/O errors that occur.
     */
    static final PrimaryKey primaryKey(H2ContentState state)
        throws Exception {
        H2DataStore dataStore = state.getDataStore();
        ContentEntry entry = state.getEntry();

...
public class H2SQLBuilderTest extends H2TestSupport {
    ...
    public void testCreate() throws Exception {
        ...
        assertEquals("CREATE TABLE \"geotools\".\"featureType1\" ("
    ...
    public void testInsert() throws Exception {
        String[] names = new String[] { "geometry", "intProperty", "doubleProperty", "stringProperty" };
        Object[] values = new Object[] {
                dataStore.getGeometryFactory().createPoint(new Coordinate(4, 4)), new Integer(4),
                new Double(4.4), "four"
            };
        String sql = encoder.insert(names, values);
        assertEquals("INSERT INTO \"geotools\".\"featureType1\" ( "
            + "\"geometry\", \"intProperty\", \"doubleProperty\", \"stringProperty\" "
            + ") VALUES ( GeometryFromText( 'POINT (4 4)', 0 ), 4, 4.4, 'four' )", sql);
    }

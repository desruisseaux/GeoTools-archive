...
import it.geosolutions.imageio.plugins.jhdf.AbstractHDFImageMetadata;
...
public class APSImageMetadata extends AbstractHDFImageMetadata{
...
//	protected Map attributesMap = Collections.synchronizedMap(new HashMap(19));
	...
	public APSImageMetadata(H4SDS dataset) {
		this();
	 ...
	 */
	private void initializeFromDataset(final H4SDS dataset) {

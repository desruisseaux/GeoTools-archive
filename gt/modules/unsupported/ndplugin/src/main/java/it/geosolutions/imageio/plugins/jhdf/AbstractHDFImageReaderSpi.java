...
public abstract class AbstractHDFImageReaderSpi extends ImageReaderSpi {

	protected final static int[] spiMutex = new int[] { 0 };
	
	public AbstractHDFImageReaderSpi(final String vendorName, String version,
	...
	/**
	 * Returns an instance of the AbstractHDFImageReader
	 * 

...
public class CacheTest extends TestCase {
	...
	public void testTracker() {
		...
		System.out.println("Unchanged=" + unchanged + ", Optimized=" + optimized + ", Empty=" + empty) ;
	...
	public void testDataCachePerformanceRandomQueries() throws IOException {
		createRandomQuerySet(50) ;
		MemoryDataStore control = new MemoryDataStore() ;
		control.createSchema(type) ;
		control.addFeatures(data) ;
	...
	protected static long compareDataStores(DataStore ds, DataStore control, List querySet) {
		...
		long meanOverhead = 0 ; int overheadCount = 0 ;
		long meanLeverage = 0 ; int leverageCount = 0 ;
		...
		System.out.println("Mean overhead = " + meanOverhead + " ms. (" + (100*overheadCount/(overheadCount+leverageCount)) + " %)") ;
		System.out.println("Mean leverage = " + meanLeverage + " ms. (" + (100*leverageCount/(overheadCount+leverageCount)) + " %)") ;
		return meanDifference ;
	}
	
	protected static boolean compareFeatureCollectionByID(FeatureCollection set1, FeatureCollection set2) {

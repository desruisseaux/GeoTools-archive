...
public class Generator {
	...
	public Feature createFeature(int i) {
		Geometry g = createRectangle(xrange*rand.nextDouble(), yrange*rand.nextDouble(), xrange*rand.nextDouble(), yrange*rand.nextDouble()) ;
	...
	public static Query createBboxQuery(Coordinate center, double xrange, double yrange) {
		...
		Filter bb = filterFactory.bbox(type.getDefaultGeometry().getName(), x_min, y_min, x_max, y_max, type.getDefaultGeometry().getCoordinateSystem().toString()) ;

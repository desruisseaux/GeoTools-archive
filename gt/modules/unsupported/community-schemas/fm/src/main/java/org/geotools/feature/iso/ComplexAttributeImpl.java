...
public class ComplexAttributeImpl implements ComplexAttribute {
	...
	protected List/*<Attribute>*/ attributes; //TODO Collection (use properties.getClass().newInstancee()
	...
	public ComplexAttributeImpl(
		Collection values, AttributeDescriptor desc, String id 
	) {
	...
	public String toString(){
		...
		.append(this.ID)
		.append(", name=")
		.append(DESCRIPTOR != null ? DESCRIPTOR.getName().toString() : "null")
		.append(", type=")

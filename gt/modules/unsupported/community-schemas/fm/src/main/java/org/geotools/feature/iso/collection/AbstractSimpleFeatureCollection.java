 ...
 * <p>
 * Because a SimpleFeatureCollection cannot contain attributes many methods
 * are stubbed to return appropriate null values, or throw
...
public abstract class AbstractSimpleFeatureCollection extends
	...
	public AbstractSimpleFeatureCollection(SimpleFeatureCollectionType type, String id) {
		this.type = type;
		this.id = id;
		this.bbox = null;
	}
	...
	public void set(List newValue) {		
		throw new IllegalArgumentException("SimpleFeatureCollection does not support properties");
	}

...
//		}
//		else if (parent instanceof SequenceType && restrict instanceof SequenceType) {
...
//	public ComplexType restriction(ComplexType parent, Collection/*<AttributeDescriptor>*/ schema) {
//		ComplexType type = null;
//		
...
//	}
	 ...
	 */
	static public List/*<AttributeDescriptor>*/ nodes(
		ComplexType schema, AttributeType type
	) {

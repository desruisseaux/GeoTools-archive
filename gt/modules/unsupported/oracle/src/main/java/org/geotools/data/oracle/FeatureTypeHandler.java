 ...
 *
 * @author wolf
 * @source $URL: http://svn.geotools.org/geotools/trunk/gt/modules/library/jdbc/src/main/java/org/geotools/data/jdbc/FeatureTypeHandler.java $
 */
public class FeatureTypeHandler {
     ...
     */
    public FeatureTypeHandler(OracleDataStore store, FIDMapperFactory fmFactory, long cacheTimeOut) {

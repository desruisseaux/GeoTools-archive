...
public class LineStringLineSegmentTest extends TestCase {
	...
	private void _testLineString1(FeatGeomFactoryImpl aGeomFactory) {
		...
		List<LineSegmentImpl> segments = line1.asLineSegments();
		assertTrue(segments.size() == 4);

		LineSegmentImpl seg1 = segments.get(0);
		LineSegmentImpl seg2 = segments.get(1);
		LineSegmentImpl seg3 = segments.get(2);
		LineSegmentImpl seg4 = segments.get(3);

...
public class CoordinateArrays {
	 ...
	 * @return
	 */
	public static List<PositionImpl> toPositionList(
			CoordinateFactoryImpl coordinateFactory, Coordinate[] coordArray) {
		List<PositionImpl> rList = new ArrayList<PositionImpl>();

 ...
 * 
 * @param duration
 * @return int[3] with years,months,days, if some value are not present -1 will
 *         be returned.
 */
 ...
 * 
 * @param duration
 * @return int[3] with hours, minutes and seconds if some value are not present
 *         -1 will be returned.
 */
 ...
 * @return Date a computed date. if duration have not got duration "P" return
 *         date value.
 * 
 */
 ...
 * @return Date a computed date. if duration have not got duration "T" return
 *         date value.
 */

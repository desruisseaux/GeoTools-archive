 ...
 * @author johann sorel
 */
public class StrategyMemoryLeackTest {

    
    private final RandomStyleFactory RANDOM_STYLE_FACTORY = new RandomStyleFactory();
    private final JDefaultEditableMap2D map = new JDefaultEditableMap2D();
    ...
    public StrategyMemoryLeackTest(){
        ...
        map.getRenderingStrategy().setContext(buildContext());
        ...
        Thread t = new Thread(){
            ...
            public void run(){
                ...
                while(true){
                    ...
                    if(val ==0){
                        map.setRenderingStrategy(new SingleVolatileImageStrategy());
                        val++;
                    }else if(val ==1){
                        map.setRenderingStrategy(new SingleVolatileImageStrategy());
                        val++;

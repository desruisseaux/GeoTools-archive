 ...
 * 10 ao�t 2005
 * 
 * SVG2MIF - Utilitaire de conversion de graphismes vectoriels vers fonds de carte.
 * Version beta 0.1
 *
 * Copyright 2005 Universit� de Toulouse Le Mirail / D�partement de G�ographie / Laurent J�gou
 * Portions : 	Copyright (c) 2004 Sun Microsystems (file filter)
 * 				Copyright (c) Carmen Delessio, carmen@elementengine.com (com.elementengine.xml)
 * http://www.univ-tlse2.fr/geoprdc
 * jegou@univ-tlse2.fr
 * 
 * Ce programme est un logiciel libre r�gi par la licence CeCILL (cf. lien ci-dessous), cette licence conf�re
 * aux utilisateurs la libert� de modification et de redistribution du logiciel, dans le cadre d'un mod�le de
 * diffusion open-source.
 * L'exercice de ces libert�s est assorti de certains devoirs � la charge des utilisateurs afin de pr�server
 * ce statut au cours des redistributions ult�rieures.
 * L�accessibilit� au code source et les droits de copie, de modification et de redistribution qui en d�coulent
 * ont pour contrepartie de n�offrir aux utilisateurs qu�une garantie limit�e et de ne faire peser sur l�auteur
 * le titulaire des droits patrimoniaux et les conc�dants successifs qu�une responsabilit� restreinte.
 * 
 * Le texte int�gral de la licence se trouve dans la disribution, ou � l'adresse suivante :
...
import org.geotools.gui.swing.toolbox.tools.svg2mif.element.xml.Element;
import org.geotools.gui.swing.toolbox.tools.svg2mif.element.xml.Parser;

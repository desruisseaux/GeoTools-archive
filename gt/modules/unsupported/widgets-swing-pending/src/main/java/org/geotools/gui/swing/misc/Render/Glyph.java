...
public class Glyph {
    ...
    public static BufferedImage icon( FeatureType ft ) {
        ...
        if( Point.class.isAssignableFrom(ft.getDefaultGeometry().getClass())
        || MultiPoint.class.isAssignableFrom(ft.getDefaultGeometry().getClass()) ){
            return point(DEFAULT_BORDER, DEFAULT_FILL);
        }

        if( LineString.class.isAssignableFrom(ft.getDefaultGeometry().getClass())
        || MultiLineString.class.isAssignableFrom(ft.getDefaultGeometry().getClass())
        || LinearRing.class.isAssignableFrom(ft.getDefaultGeometry().getClass())){
            return line(DEFAULT_BORDER, 1);
        }

        if( Polygon.class.isAssignableFrom(ft.getDefaultGeometry().getClass())
        || MultiPolygon.class.isAssignableFrom(ft.getDefaultGeometry().getClass()) ){

 ...
 * @author johann sorel
 */
public class MultiContextTreeDrop extends DropTarget {
    ...
    private MultiContextTreeTransferHandler handler;
     ...
     */
    public MultiContextTreeDrop(MultiContextTreeTransferHandler h) {
        this.handler = h;
    }

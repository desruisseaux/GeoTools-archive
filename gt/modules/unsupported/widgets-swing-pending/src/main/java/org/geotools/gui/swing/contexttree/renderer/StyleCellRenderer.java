...
public class StyleCellRenderer implements TableCellRenderer, RolloverRenderer, Serializable {
     ...
     */
    public StyleCellRenderer(ComponentProvider componentController) {
     ...
     *
     */
    public StyleCellRenderer(StringValue converter) {

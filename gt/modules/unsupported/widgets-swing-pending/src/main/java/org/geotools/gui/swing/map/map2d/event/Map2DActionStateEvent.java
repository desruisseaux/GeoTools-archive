...
/**
 * Map2DActionStateEvent Event generated by a NavigableMap2D
 * @author Johann Sorel
 */
public class Map2DActionStateEvent extends EventObject{
    ...
    /**
     * create a Map2DActionStateEvent
     * @param map : Map2D source componant
     * @param oldone : previous action state
     * @param newone : new action state
     */

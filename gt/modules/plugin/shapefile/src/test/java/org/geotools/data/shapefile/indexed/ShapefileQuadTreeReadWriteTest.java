 ...
 * @version $Id: ShapefileQuadTreeReadWriteTest.java 28476 2007-12-21 20:30:22Z
 *          jgarnett $
...
public class ShapefileQuadTreeReadWriteTest extends TestCaseSupport {
    ...
    public void testWriteTwice() throws Exception {
        ...
        DataStore s1 = createDataStore(fac, TestData.url(this,
                "shapes/stream.shp"), true);
    ...
    private DataStore createDataStore(ShapefileDataStoreFactory fac, URL url,
    ...
    void test(String f) throws Exception {
        File file = copyShapefiles(f); // Work on File rather than URL from
                                        // JAR.
        DataStore s = createDataStore(new ShapefileDataStoreFactory(), file
                .toURL(), true);
    ...
    public void testGetBoundsQuery() throws Exception {
        ...
        params.put(ShapefileDataStoreFactory.CREATE_SPATIAL_INDEX.key,
                new Boolean(true));
        IndexedShapefileDataStore ds = (IndexedShapefileDataStore) fac
        ...
        FeatureCollection features = ds.getFeatureSource().getFeatures(filter);
    ...
    public static final void main(String[] args) throws Exception {
        ...
        junit.textui.TestRunner
                .run(suite(ShapefileQuadTreeReadWriteTest.class));
    }
}

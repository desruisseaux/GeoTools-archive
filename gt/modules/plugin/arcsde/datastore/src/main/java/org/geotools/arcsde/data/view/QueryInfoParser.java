...
/**
 * Visits a {@link net.sf.jsqlparser.statement.select.PlainSelect} SQL SELECT construct
 * to create the correspondent {@link com.esri.sde.sdk.client.SeQueryInfo} object, that
...
public class QueryInfoParser {
	 ...
	 * 
	 * @param selectItems 
	 * @return <code>null</code> if <code>selectItems</code> is null or contains
	 * only an {@link net.sf.jsqlparser.statement.select.AllColumns}
	 */
	private static String[] getColumns(SeConnection conn, List selectItems)
	throws SeException{

 ...
 * @source $URL:
 *         http://svn.geotools.org/geotools/trunk/gt/modules/plugin/arcsde/datastore/src/test/java/org/geotools/arcsde/gce/ArcSDEGCReaderSymbolizedTest.java $
 * @version $Id: ArcSDEGCReaderSymbolizedTest.java 28048 2007-11-26 12:53:18Z
 *          groldan $
 */
public class ArcSDEGCReaderSymbolizedTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        InputStream in = org.geotools.test.TestData.url(null, "testRasterStyle.sld.xml")
                .openStream();
        SLDParser parser = new SLDParser(CommonFactoryFinder.getStyleFactory(GeoTools
                .getDefaultHints()));
        parser.setInput(in);
        StyledLayerDescriptor sld = parser.parseSLD();
        NamedLayer layerOne = (NamedLayer) sld.getStyledLayers()[0];
        symbolizer = (RasterSymbolizer) layerOne.getStyles()[0].getFeatureTypeStyles()[0]
                .getRules()[0].getSymbolizers()[0];
    }

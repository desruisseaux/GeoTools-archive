...
public class ArcSDEGCReaderSpatialTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        highRes = new GridGeometry2D(new GeneralGridRange(new Rectangle(1000,1000)), new ReferencedEnvelope(150000.0,151000.0,900000.0,901000.0,crs));
        medRes = new GridGeometry2D(new GeneralGridRange(new Rectangle(500,500)), new ReferencedEnvelope(150000.0,151000.0,900000.0,901000.0,crs));
        lowRes = new GridGeometry2D(new GeneralGridRange(new Rectangle(200,200)), new ReferencedEnvelope(30000.0,300000.0,630000.0,900000.0,crs));
        ...
        // 33,000.25Â m 782,500.143Â m , 332,999.75Â m 953,499.857Â m], java.awt.Rectangle[x=0,y=0,width=500,height=285]
    ...
    public void testRead3BandCoverage() throws Exception {
        ...
        assertNotNull(gc);
        //ImageIO.write(gc.geophysics(true).getRenderedImage(), "PNG", new File("threebandOutput1.png"));
        assertTrue("Image from SDE isn't what we expected.",
                RasterTestUtils.imageEquals(gc.geophysics(true).getRenderedImage(),
                        "threeBandOutput1.png"));
            
        
        requestParams[0] = new Parameter(AbstractGridFormat.READ_GRIDGEOMETRY2D,medRes);
        gc = (GridCoverage2D)r.read(requestParams);
        assertNotNull(gc);
        //ImageIO.write(gc.geophysics(true).getRenderedImage(), "PNG", new File("threeBandOutput2.png"));
        assertTrue("Image from SDE isn't what we expected.",
                RasterTestUtils.imageEquals(gc.geophysics(true).getRenderedImage(),
                        "threeBandOutput2.png"));
        
        requestParams[0] = new Parameter(AbstractGridFormat.READ_GRIDGEOMETRY2D,lowRes);
        gc = (GridCoverage2D)r.read(requestParams);
        assertNotNull(gc);
        //ImageIO.write(gc.geophysics(true).getRenderedImage(), "PNG", new File("threeBandOutput3.png"));
        assertTrue("Image from SDE isn't what we expected.",
                RasterTestUtils.imageEquals(gc.geophysics(true).getRenderedImage(),
                        "threeBandOutput3.png"));
        
        requestParams[0] = new Parameter(AbstractGridFormat.READ_GRIDGEOMETRY2D,realWordlExampleRes);
        gc = (GridCoverage2D)r.read(requestParams);
        assertNotNull(gc);
        //ImageIO.write(gc.geophysics(true).getRenderedImage(), "PNG", new File("threeBandOutput4.png"));
        assertTrue("Image from SDE isn't what we expected.",
                RasterTestUtils.imageEquals(gc.geophysics(true).getRenderedImage(),
                        "threeBandOutput4.png"));
    }
    ...
    public void testRead4BandCoverage() throws Exception {
        ...
        gc = (GridCoverage2D)r.read(requestParams);
        assertNotNull(gc);
        //ImageIO.write(gc.geophysics(true).getRenderedImage(), "PNG", new File("fourbandOutput1.png"));
        assertTrue("Image from SDE isn't what we expected.",
                RasterTestUtils.imageEquals(gc.geophysics(true).getRenderedImage(),
                        "fourbandOutput1.png"));
        ...
        gc = (GridCoverage2D)r.read(requestParams);
        assertNotNull(gc);
        //ImageIO.write(gc.geophysics(true).getRenderedImage(), "PNG", new File("fourbandOutput2.png"));
        assertTrue("Image from SDE isn't what we expected.",
                RasterTestUtils.imageEquals(gc.geophysics(true).getRenderedImage(),
                        "fourbandOutput2.png"));
        ...
        gc = (GridCoverage2D)r.read(requestParams);
        assertNotNull(gc);
        //ImageIO.write(gc.geophysics(true).getRenderedImage(), "PNG", new File("fourbandOutput3.png"));
        assertTrue("Image from SDE isn't what we expected.",
                RasterTestUtils.imageEquals(gc.geophysics(true).getRenderedImage(),
                        "fourbandOutput3.png"));
        ...
        gc = (GridCoverage2D)r.read(requestParams);
        assertNotNull(gc);
        //ImageIO.write(gc.geophysics(true).getRenderedImage(), "PNG", new File("fourbandOutput4.png"));
        assertTrue("Image from SDE isn't what we expected.",
                RasterTestUtils.imageEquals(gc.geophysics(true).getRenderedImage(),
                        "fourbandOutput4.png"));
    }

 ...
 */
public class GeoTiffReaderMain extends javax.swing.JFrame {
    
    
    /** Creates new form TiffMetadataOpener */
    public GeoTiffReaderMain() {
        initComponents();
    }
    ...
    public static void main(String args[]) throws Exception {
        new GeoTiffReaderMain().show();
        
        JFileChooser jfc = new JFileChooser( TestData.file( GeoTiffReaderMain.class, "cir.tif"));

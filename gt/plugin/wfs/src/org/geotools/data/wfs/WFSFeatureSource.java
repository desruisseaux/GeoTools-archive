...
public class WFSFeatureSource extends AbstractFeatureSource {
    ...
    public Envelope getBounds() throws IOException {
    	return getBounds(ft==null?Query.ALL:new DefaultQuery(ft.getTypeName()));
    }
	/* (non-Javadoc)
	...
	public static class WFSFeatureResults implements FeatureResults{
		...
		public FeatureCollection collection() throws IOException {
	        try {
	            ...
	            FeatureReader reader = fs.ds.getFeatureReader(query,fs.getTransaction());

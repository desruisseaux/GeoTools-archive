...
public class SQLEncoderHsql extends SQLEncoder
    ...
    public void visit(GeometryFilter filter) throws RuntimeException {
        ...
        if (filter.getFilterType() == AbstractFilter.GEOMETRY_BBOX) {
            ...
            left.expressionType = DefaultExpression.ATTRIBUTE_GEOMETRY;
    ...
    /**
     * This should be overridden here to add 'GeomFromWKT()' around the
     * column name if the column is a geometry column.
     * 
    ...
    public void visit(AttributeExpression expression) throws RuntimeException {
        ...
        try {
        	...
        	if( expression.getType() == expression.ATTRIBUTE_GEOMETRY ) {
//        		out.write(escapeName(expression.getAttributePath()));
        		out.write("GeomFromWKT(" + escapeName(expression.getAttributePath()) + ")");
        	} else {

...
import org.geotools.data.wms.capabilities.Attribution;
import org.geotools.data.wms.capabilities.AuthorityURL;
import org.geotools.data.wms.capabilities.BoundingBox;
import org.geotools.data.wms.capabilities.Capability;
import org.geotools.data.wms.capabilities.ContactAddress;
import org.geotools.data.wms.capabilities.ContactInformation;
import org.geotools.data.wms.capabilities.ContactPersonPrimary;
import org.geotools.data.wms.capabilities.DCPType;
import org.geotools.data.wms.capabilities.DataURL;
import org.geotools.data.wms.capabilities.DescribeLayer;
import org.geotools.data.wms.capabilities.Dimension;
import org.geotools.data.wms.capabilities.Exception;
import org.geotools.data.wms.capabilities.Extent;
import org.geotools.data.wms.capabilities.FeatureListURL;
import org.geotools.data.wms.capabilities.Get;
import org.geotools.data.wms.capabilities.GetCapabilities;
import org.geotools.data.wms.capabilities.GetFeatureInfo;
import org.geotools.data.wms.capabilities.GetLegendGraphic;
import org.geotools.data.wms.capabilities.GetMap;
import org.geotools.data.wms.capabilities.GetStyles;
import org.geotools.data.wms.capabilities.HTTP;
import org.geotools.data.wms.capabilities.HTTPRequestType;
import org.geotools.data.wms.capabilities.Identifier;
import org.geotools.data.wms.capabilities.LatLonBoundingBox;
import org.geotools.data.wms.capabilities.Layer;
import org.geotools.data.wms.capabilities.LegendURL;
import org.geotools.data.wms.capabilities.LogoURL;
import org.geotools.data.wms.capabilities.MetadataURL;
import org.geotools.data.wms.capabilities.Post;
import org.geotools.data.wms.capabilities.PutStyles;
import org.geotools.data.wms.capabilities.Request;
import org.geotools.data.wms.capabilities.RequestType;
import org.geotools.data.wms.capabilities.ScaleHint;
import org.geotools.data.wms.capabilities.Service;
import org.geotools.data.wms.capabilities.Style;
import org.geotools.data.wms.capabilities.StyleSheetURL;
import org.geotools.data.wms.capabilities.StyleURL;
import org.geotools.data.wms.capabilities.UserDefinedSymbolization;
import org.geotools.data.wms.capabilities.VendorSpecificCapabilities;
import org.geotools.data.wms.capabilities.WMT_MS_Capabilities;
import org.geotools.data.wms.capabilities.WmsURL;

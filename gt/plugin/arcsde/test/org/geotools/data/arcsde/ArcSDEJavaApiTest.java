 ...
 * 
 * <p>
 * Some of this tests asserts the information from the documentation found on
 * <a href="http://arcsdeonline.esri.com">arcsdeonline</a>, and others are
 * needed to validate our assumptions in the API behavoir due to the very
 * little documentation ESRI provides about the less obvious things.
 * </p>
 *
...
public class ArcSDEJavaApiTest extends TestCase {
    /** package logger */
    private static Logger LOGGER = Logger.getLogger(ArcSDEJavaApiTest.class.getPackage()
                                                                           .getName());
    ...
    public void testCalculateCount() throws Exception {
        try {
            ...
            SeTable.SeTableStats tableStats = query.calculateTableStatistics("POP_ADMIN",
     ...
     */
    public void testGenericSeCoordinateReferenceLimits()
        throws SeException {
    ...
    public void testLineStringFormat() throws SeException {
        ...
        SeShape point = new SeShape();
        int numParts = 1;
        int[] partOffsets = { 0 }; //index of each part's start in the gobal coordinate array
    ...
    public void testMultiLineStringFormat() throws SeException {
        ...
        SeShape point = new SeShape();
        int numParts = 2;
        int[] partOffsets = { 0, 2 }; //index of each part's start in the gobal coordinate array
        point.generateLine(numPts, numParts, partOffsets, ptArray);
    ...
    public void testPolygonFormat() throws SeException {
        /*
         *   Generate an area shape composed of two polygons,
         * the first with a hole
         */
        int numPts = 4;
        int numParts = 1;

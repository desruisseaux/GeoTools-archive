        ...
        for (; !it.isDone(); it.next()) {
            switch (it.currentSegment(buffer)) {
                ...
                case PathIterator.SEG_CUBICTO: {
                     ...
                     * l'utilisation d'un 'break' plut�t que 'continue'.
                     *
                     * NOTE: Le point calcul� est bien sur la courbe, mais n'est pas
                     *       n�cessairement repr�sentatif. Cet algorithme remplace les
                     *       deux points de contr�les par un seul, ce qui se traduit par
                     *       une perte de souplesse qui peut donner de mauvais r�sultats
                     *       si la courbe cubique �tait bien tordue. Projeter une courbe
                     *       cubique ne me semble pas �tre un probl�me simple, mais ce
                     *       cas devrait �tre assez rare. Il se produira le plus souvent
                     *       si on essaye de projeter un cercle ou une ellipse, auxquels
                     *       cas l'algorithme actuel donnera quand m�me des r�sultats
                     *       tol�rables.
                     */
                    indexLastPt = 4;
                    indexCtrlPt = 0;

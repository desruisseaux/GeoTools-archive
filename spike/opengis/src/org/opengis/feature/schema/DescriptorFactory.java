...
public interface DescriptorFactory {
	...
	public OrderedDescriptor ordered( List<? extends Descriptor> sequence, int min, int max );
	public ChoiceDescriptor choice( Set<? extends Descriptor> options, int min, int max );
}

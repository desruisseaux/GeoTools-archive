...
public interface Feature extends ComplexAttribute  {
    ...
    * <p>
    * Care must be taken to avoid generation based things that will change over time (mutable
    * attribtues, or shapefile rows). It is hoped that the domain being modeled will have specific
    * identity practices in palce that you can depend on, as example Airports make use of standards
    ...
    * <p>
    * This information is available as an optional attribute in a GML document, the idea is sound:
    * if avalable the CRS information for a feature should be available here.
    * </p>
    ...
    * <p>
    * This should be a "shadow" of information available as part of the attribue model,
    * for instance of BoundedFeatureType should how bounds as a required attribute
    * and you would be able to expect a non null value from this method.
    * </p>
    * <p>
    * It is assumed the returned Envelope has a CRS, if not you can assume the value of getCRS()
    * applies?
    * </p>

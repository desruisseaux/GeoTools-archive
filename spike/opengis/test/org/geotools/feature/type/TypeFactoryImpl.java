...
public class TypeFactoryImpl implements TypeFactory {
	...
	public ComplexTypeImpl createType(QName name, Descriptor schema,
		...
		return new ComplexTypeImpl(name, schema, identified, binding,
	...
	public FeatureTypeImpl createFeatureType(QName name, Descriptor schema,
		...
		if(schema instanceof SimpleDescriptor){
			return createFeatureType(name, (SimpleDescriptor)schema, defaultGeom, isAbstract);
		}
	...
	public SimpleFeatureTypeImpl createFeatureType(
		...
		return createFeatureType(name, descriptor, defaultGeometry, false);
	}

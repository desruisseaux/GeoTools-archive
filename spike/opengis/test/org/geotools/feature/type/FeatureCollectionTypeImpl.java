...
public class FeatureCollectionTypeImpl extends FeatureTypeImpl implements FeatureCollectionType {
	...
	public FeatureCollectionTypeImpl( QName name, Collection<FeatureType> memberTypes, Schema schema, AttributeType defaultGeom) {
		super(name, schema, defaultGeom);
		MEMBERTYPES = memberTypes;
	}
	public FeatureCollectionTypeImpl( QName name, Collection<FeatureType> memberTypes, Schema schema, AttributeType defaultGeom, Set<Filter> restrictions, ComplexType superType, boolean isAbstract){

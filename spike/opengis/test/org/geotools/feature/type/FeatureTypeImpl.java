...
public class FeatureTypeImpl extends ComplexTypeImpl implements FeatureType {
	...
	public FeatureTypeImpl(String name, Descriptor schema,
			GeometryType defaultGeom) {
		this(new QName(name), schema, defaultGeom);
	}

	public FeatureTypeImpl(QName name, Descriptor schema,
			GeometryType defaultGeom) {
		super(name, schema, true, false, null);
	...
	public FeatureTypeImpl(QName name, Descriptor schema,
		...
		super(name, schema, true, false, restrictions, superType,
				isAbstract);
		setDefault(defaultGeom);
	}

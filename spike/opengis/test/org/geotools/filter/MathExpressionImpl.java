...
public class MathExpressionImpl extends DefaultExpression
     ...
     */
    public Object getValue(Attribute att) throws IllegalArgumentException {
        ...
        double leftDouble = ((Number) leftValue.getValue(att))
            .doubleValue();
        double rightDouble = ((Number) rightValue.getValue(att))
            .doubleValue();

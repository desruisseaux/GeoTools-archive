...
public class FilterFunction_interiorRingN extends FunctionExpressionImpl implements FunctionExpression 
{
...
public Object getValue(Attribute att)
{
      ...
      {
            throw new IllegalArgumentException("Filter Function problem for function interiorRingN argument #0 - expected type Geometry");
      }
      ...
      {
            throw new IllegalArgumentException("Filter Function problem for function interiorRingN argument #1 - expected type int");
      }

...
public class CompareFilterImpl extends AbstractFilterImpl
	...
	if (!(leftValue.getValue(att) instanceof Number && 
	      rightValue.getValue(att) instanceof Number))
	{
		...
		if (LOGGER.isLoggable(Level.FINEST)) 
        {
            ...
            LOGGER.finest("left value class: "
                + leftValue.getValue(att).getClass().toString());
            LOGGER.finest("right value class: "
                + rightValue.getValue(att).getClass().toString());
        }
		
		    Object leftObj = leftValue.getValue(att);
		    Object rightObj = rightValue.getValue(att);
            ...
            // Math comparisons
            double leftResult = ((Number) leftValue.getValue(att))
                .doubleValue();
            double rightResult = ((Number) rightValue.getValue(att))
                .doubleValue();

...
public class ChoiceImplTest extends TestCase {
	...
	public void testEquals() {
		ChoiceImpl choice = new ChoiceImpl(new HashSet<AttributeDescriptor>());
		...
		NodeImpl node3 = new NodeImpl(type1, 0, Integer.MAX_VALUE);
		...
		choice = new ChoiceImpl(content1);
		ChoiceImpl choice2 = new ChoiceImpl(content2);
		
		assertFalse(choice.equals(choice2));
		choice2 = new ChoiceImpl(content1);
		assertTrue(choice.equals(choice2));
	}
	...
	public void testConstructDuplicateNames(){
		...
		Set<AttributeDescriptor>choiceContents = new HashSet<AttributeDescriptor>();
		choiceContents.add(node1);
		choiceContents.add(node2);
		try{
			new ChoiceImpl(choiceContents, 1, 1);

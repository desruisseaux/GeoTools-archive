...
public class BusinessDriverExamplesTest extends ComplexTestData {
	...
	public void test01SingleRepeatedProperty() {
		...
		FeatureType wqPlusType = ComplexTestData.createExample01MultiValuesComplexProperty(
	...
	/**
	 * Test construction of a FeatureType matching the following XML Schema,
	 * where the properties "measurement" and "sitename" may have various
	 * instances.
	 * 
	 * <pre><code>
	 ...
	 * 
	 */
	public void test02MultipleRepeatedProperties() {

		FeatureType wqPlusType = ComplexTestData.createExample02MultipleMultivalued(
				typeFactory, descFactory);
	...
	public void test03MultipleGeometryAttributes() {
		...
		FeatureType<?> wqPlusType = ComplexTestData.createExample03MultipleGeometries(
				typeFactory, descFactory);
		...
		final String[] names = { "measurement", "location", "nearestSlimePit",
				"sitename" };
		final int[][] multiplicities = { { 1, Integer.MAX_VALUE }, { 1, 1 },
	...
	/**
	 * Tests that properties from multiple namespaces can cohexists in a
	 * FeatureType
	 */
	public void test04MultipleNameSpaces() {

		FeatureType<?> wqPlusType = ComplexTestData.createExample04Type(
				typeFactory, descFactory);
		...
		final QName[] names = { new QName(NSURI, "name"),
				new QName(GML_NSURI, "name") };
		final int[][] multiplicities = { { 1, Integer.MAX_VALUE },
				{ 1, Integer.MAX_VALUE } };
		int i = 0;
		for (Descriptor attDesc : contents) {
			assertTrue(attDesc instanceof AttributeDescriptor);
			...
			assertEquals(names[i], att.getType().getName());
		...
		assertNull(wqPlusType.getDefaultGeometry());
	}

	public void test05InterRelatedFeatures() {

...
public class FilterEqualsTest extends TestCase {
	...
	protected void setUp() {
		...
		testFeature = attf.create(testSchema, null, Arrays.asList( attributes));
	...
	public void testExpressionMath() {
		try {
			...
			assertTrue(!testMath1.equals(testMath2));
			assertTrue(!testMath1
					.equals("Random Object that happens to be a string"));
		} catch (IllegalFilterException e) {
			LOGGER.warning("bad filter: " + e.getMessage());
		}
	...
	public void testExpressionAttribute() throws IllegalFilterException {
		AttributeType[] testAttr2 = {
				typeFactory.createType("testBoolean", Boolean.class),
				typeFactory.createType("testString", String.class) };

		FeatureType testSchema2 = typeFactory.createFeatureType("test2", Arrays
				.asList(testAttr2), null);
	...
	public void testCompareFilter() throws IllegalFilterException {
		CompareFilterImpl cFilter1 = new CompareFilterImpl(
				AbstractFilter.COMPARE_EQUALS);
		CompareFilterImpl cFilter2 = new CompareFilterImpl(
				AbstractFilter.COMPARE_EQUALS);
	...
	public void testBetweenFilter() throws IllegalFilterException {
		...
		LiteralExpressionImpl testLit1 = new LiteralExpressionImpl(new Integer(
				55));
		LiteralExpressionImpl testLit2 = new LiteralExpressionImpl(new Integer(
				55));
		testExp1 = new LiteralExpressionImpl(new Integer(45));
		testExp2 = new LiteralExpressionImpl(new Integer(45));
		testExp3 = new AttributeExpressionImpl(testSchema, "testInteger");
	...
	public void testLogicFilter() throws IllegalFilterException {
		...
		cFilter2.addRightValue(testExp4);
		LogicFilterImpl logFilter1 = new LogicFilterImpl(cFilter1, cFilter2,
				AbstractFilter.LOGIC_AND);
		LogicFilterImpl logFilter2 = new LogicFilterImpl(cFilter1, cFilter2,
				AbstractFilter.LOGIC_AND);
		...
		Filter logFilter3 = new LogicFilterImpl(logFilter1, logFilter2,
				AbstractFilter.LOGIC_OR);
		Filter logFilter4 = new LogicFilterImpl(logFilter1, logFilter2,
				AbstractFilter.LOGIC_OR);
	...
	public void testGeometryFilter() throws IllegalFilterException {
		GeometryFilterImpl geomFilter1 = new GeometryFilterImpl(
				AbstractFilter.GEOMETRY_DISJOINT);
		GeometryFilterImpl geomFilter2 = new GeometryFilterImpl(
				AbstractFilter.GEOMETRY_DISJOINT);
		testExp1 = new LiteralExpressionImpl(new Integer(45));
		testExp2 = new LiteralExpressionImpl(new Integer(45));

...
public class WMSService extends Service {
        ...
        if (wms == null) {
            try {
                ...
                IOException broken = new IOException( 
            		...
            		"Could not connect to WMS. Possible reason: " + nak.getLocalizedMessage()
            	);
        ...
        if (info == null){
            synchronized(getWMS( monitor )){
                if(info == null){
                	...
                	ResolveDelta delta = new DefaultResolveDelta( this, ResolveDelta.Kind.CHANGED );
                	parent(monitor).fire(new DefaultResolveChangeEvent( this, ResolveChangeEvent.Type.POST_CHANGE, delta )  );
            	}
            }
        }
        return info;
	...
	public class CustomWMS extends WebMapServer {
		...
		public GetCapabilitiesResponse issueRequest( GetCapabilitiesRequest arg0 ) throws IOException, ServiceException, SAXException {
            return super.issueRequest(arg0);
        }

        public GetFeatureInfoResponse issueRequest( GetFeatureInfoRequest arg0 ) throws IOException, ServiceException, SAXException {
            return super.issueRequest(arg0);
        }

        public GetMapResponse issueRequest( GetMapRequest arg0 ) throws IOException, ServiceException, SAXException {

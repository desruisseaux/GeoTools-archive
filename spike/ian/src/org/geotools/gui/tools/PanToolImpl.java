 ...
 *
 * @author $author$
 * @source $URL: http://svn.geotools.org/geotools/trunk/gt/module/migrate/src/org/geotools/gui/tools/PanToolImpl.java $
...
public class PanToolImpl extends AbstractTool implements PanTool {
    ...
    public void mouseClicked(MouseEvent e) {
        try {
            ...
            GeneralDirectPosition mousePoint =
    ...
    protected void applyZoomTransform(
        GeneralDirectPosition midPoint,

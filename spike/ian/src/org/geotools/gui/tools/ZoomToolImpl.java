 ...
 * @source $URL: http://svn.geotools.org/geotools/trunk/gt/module/migrate/src/org/geotools/gui/tools/ZoomToolImpl.java $
 * @version $Id$
 */
public class ZoomToolImpl extends PanToolImpl implements ZoomTool {
    ...
    public void mouseReleased(MouseEvent e) {
        try {
            ...
            GeneralDirectPosition midpoint = new GeneralDirectPosition((pressPoint.getOrdinate(

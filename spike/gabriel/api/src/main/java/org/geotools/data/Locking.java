...
public interface Locking<T extends FeatureType, F extends Feature, C extends FeatureCollection<T, F>>
     ...
     * operations are against the "current" transaction. If a FeatureLock is not
     * provided lock operations will only be applicable for the current
     ...
     * 
     * <ul>
     * <li> Be recorded against the provided FeatureLock. </li>
     * <li> Be recorded against the current transaction if no FeatureLock is
     * provided. </li>
     * </ul>
     * 
     * <p>
     ...
     * 
     * <p>
     * The method does not prevent addFeatures() from being used (we could add a
     * lockDataSource() method if this functionality is required.
     * </p>
     * 

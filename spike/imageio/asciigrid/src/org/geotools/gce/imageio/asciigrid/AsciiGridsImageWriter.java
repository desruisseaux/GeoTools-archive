...
import it.geosolutions.imageio.stream.output.exp.GZIPImageOutputStream;
import it.geosolutions.imageio.stream.output.exp.GZIPFilterImageOutputStreamExt;
	...
	public void write(IIOMetadata streamMetadata, IIOImage image,
		...
		if (param == null) {
			...
			if (compression == ImageWriteParam.MODE_DEFAULT) {
					...
					imageOutputStream = new GZIPImageOutputStream(
							 imageOutputStream);
